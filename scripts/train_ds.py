...
# Specify the alignment as a command line argument
args = sys.argv
if len(args) < 2:
    sys.exit('I couldn\'t see an MSA file there, sorry')
msa_file = args[1]
...
data_params = {"dataset": os.path.basename(msa_file)}
...
if __name__ == "__main__":
    ...
    data_helper = helper.DataHelper(alignment_file=msa_file,
                                    calc_weights=True)
